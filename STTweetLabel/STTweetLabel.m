...
+ (NSCharacterSet *)validCharactersSet
{
...
- (void)setupLabel {
    ...
    _attributesText = @{NSForegroundColorAttributeName: [UIColor colorWithRed:86/255.0 green:86/255.0 blue:86/255.0 alpha:1.0], NSFontAttributeName: [UIFont systemFontOfSize:14.0f]};
    _attributesHandle = @{NSForegroundColorAttributeName: [UIColor blackColor], NSFontAttributeName: [UIFont systemFontOfSize:14.0f]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [UIColor blackColor], NSFontAttributeName: [UIFont systemFontOfSize:14.0f]};
    _attributesLink = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:129.0/255.0
                                                                               green:171.0/255.0
                                                                                blue:193.0/255.0
                                                                               alpha:1.0],
...
- (void)determineHotWords
{
    ...
    NSCharacterSet *validCharactersSet = [self.class validCharactersSet];
...
{
    [self setText:text attributes:attributes hotWords:nil detectHotWords:detectHotWords];
}
